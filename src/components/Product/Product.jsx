            ...
            <div className="grid items-start grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="w-full lg:sticky top-[120px] sm:flex gap-2">
                <div className="sm:space-y-3 w-16 max-sm:flex max-sm:mb-4 max-sm:gap-4">
                  <Image
                    ...
                    src={product.image}
                    alt="Product1"
                    className="w-full  hidden md:flex cursor-pointer border-2 border-black rounded-sm outline"
                  />
                </div>
                <div className="flex justify-center w-full h-[5x0vh] items-center mb-2 pt-2">
                  <Image
                    src={product.image}
                    width={400}
                    height={100}
                    alt="Product"
                    className="w-[300px] flex justify-center rounded object-cover"
                  />
                </div>
              </div>
              ...
              <div className="max-w-[450px] relative">
                ...
                <p className="text-sm mt-4">
                  Vendedor: <span className="text-blue-500">Alan Opresnik</span>
                </p>
                {/* <div className="mt-8">
...
*/}
                ...
                <div>
                  ...
                  <div className="border w-fit  rounded-full mt-2">
                    <Button className="!text-gray-800 text-xl rounded-full">
                      +
                    </Button>
